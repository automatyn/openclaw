...
<body class="hero-gradient">
    <nav class="border-b border-zinc-900 px-6 py-5">
        <div class="max-w-6xl mx-auto flex justify-between items-center">
            <a href="/" class="text-2xl font-extrabold text-white" style="font-family: 'Cabinet Grotesk', sans-serif !important; letter-spacing: -0.04em;">Automatyn<span style="color:#22d3ee;">.</span></a>
